...
| --- | --- | --- |
| System Overview (`system.html`) | [`system.md`](system.md) | [`../system.md`](../system.md) |
| First Steps (`first_steps.html`) | [`first-steps.md`](first-steps.md) | out-of-scope for most agents |
| Show File Handling (`show_file_management.html`) | [`show-file-handling.md`](show-file-handling.md) | [`../show-file-handling.md`](../show-file-handling.md) |
...
| Single / Multi User (`user.html`) | [`users.md`](users.md) | [`../users.md`](../users.md), [`../multi-station.md`](../multi-station.md) |
...
| MAtricks (`matricks.html`) | [`matricks.md`](matricks.md) | [`../matricks.md`](../matricks.md) |
| Cues and Sequences (`cue_sequence.html`) | [`cues-sequences.md`](cues-sequences.md) | [`../cues-sequences.md`](../cues-sequences.md) |
| Executors (`executor.html`) | [`executors.md`](executors.md) | [`../executors.md`](../executors.md), [`../hardware-layout.md`](../hardware-layout.md) |
| Masters (`masters.html`) | [`masters.md`](masters.md) | [`../masters.md`](../masters.md) |
| Recipes (`recipes.html`) | [`recipes.md`](recipes.md) | [`../recipes.md`](../recipes.md), [`../phaser-recipe.md`](../phaser-recipe.md) |
...
| Quickeys (`quickeys.html`) | [`quickeys.md`](quickeys.md) | [`../quickeys.md`](../quickeys.md) |
