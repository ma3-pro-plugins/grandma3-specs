...
```
Assign View 2 At ViewButton 2.3
```
---|---  
...
```
Assign Appearance 3 At Group 5
```
---|---  
...
```
Assign Appearance 1 At Sequence 2 + 3 + 4
```
---|---  
...
```
Assign Off Tag "ArgleBargle" At Sequence 3
```
---|---  
...
```
Assign Sequence 1 At Sequence 2
```
---|---  
...
```
Assign Filter "Only Dimmer" At ScreenContent 1.1.1
```
---|---  
...
```
Assign World 1 At ScreenContent 1.1.1
```
---|---  
