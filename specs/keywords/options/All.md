...
```
LoadShow "Fiddler on the Roof" /All
```
---|---  
...
```
NewShow "Rocky Horror Picture Show" /All
```
---|---  
...
```
AutoCreate Selection At Group 21 /All
```
---|---  
...
```
AutoCreate FixtureClass "Spots" At Group 301 /All
```
---|---  
...
```
AutoCreate FixtureLayer "Backtruss" At Group 201 /All
```
---|---  
...
```
AutoCreate FixtureType 10 At Group 42 /All
```
---|---
