...
| **Hint:** |
| --- |
| If you use SetUserVariable or SetGlobalVariable in combination with /Look, the proper value of the UI will be used in the variable. Whereas, using SetUserVariable and SetGlobalVariable without /Look will use the internal representation of the value, for example in form of numbers. |
...
| User name[Fixture]>SetUserVariable "mySeqPrioNumber" At Sequence 42 Property "Priority" |
| --- |
