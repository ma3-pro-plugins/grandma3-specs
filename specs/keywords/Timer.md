...
kind: general
shortcuts: []
manual_url: "https://help.malighting.com/grandMA3/2.5/HTML/keyword_timer.html"
---
...
For more information on timers see [Timers topic](https://help.malighting.com/grandMA3/2.5/HTML/timers.html).
...
In some settings you have to assign an object. To do so use the [Assign Keyword](https://help.malighting.com/grandMA3/2.5/HTML/keyword_assign.html).

Other settings contain a text option or a value. Use the [Set keyword](https://help.malighting.com/grandMA3/2.5/HTML/keyword_set.html) for these settings.
...
For more information on the settings of the Timer see [Timer](https://help.malighting.com/grandMA3/2.5/HTML/timers.html).
...
```
Set Timer 2 "TimerMode" "Countdown"
```
---|---  
...
```
Set Timer 2 "CountdownDuration" 25
```
---|---
